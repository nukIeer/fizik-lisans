...
\begin{titlepage}
    ...
    { \huge \bfseries FZKT2412 - Akustik Fizik\\
    Ders Notları\\[0.4cm] }
    ...
    \begin{tabular}{rl}
        ...
        \textbf{Öğretim Elemanı:} & Prof. Dr. FEYZA GÜZELÇİMEN \\
...
\section{Giriş}
Bu doküman, FZKT2412 Akustik Fizik dersinin notlarını içermektedir.
